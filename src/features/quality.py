...
def compute_fundamental_features(df: pd.DataFrame, *args: object, **kwargs: object) -> pd.DataFrame:
...
def compute_technical_features(df: pd.DataFrame, *args: object, **kwargs: object) -> pd.DataFrame:
