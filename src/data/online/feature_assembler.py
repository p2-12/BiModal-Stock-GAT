...
class OnlineFeatureAssembler:
    ...
    def assemble(self, ticker: str, now_utc: dt.datetime, lookback_days: int = 200) -> dict[str, float]:
        ...
        df = pd.DataFrame([
            {"Date": b.timestamp_utc, "Open": b.open, "High": b.high, "Low": b.low, "Close": b.close, "Volume": b.volume}
            for b in bars
        ...
        news = self.news_aggregator.fetch_filtered([ticker], now_utc - dt.timedelta(days=3), now_utc)
        return {
